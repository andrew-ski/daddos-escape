...
sprites.onOverlap(SpriteKind.Player, SpriteKind.bossTrophy, function (sprite, otherSprite) {
    otherSprite.destroy()
    music.playMelody("D E G G A B C5 C5 ", 600)
})
...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile4, function (sprite, location) {
    currentLevel += 1
    music.playMelody("D E F G C5 C5 - - ", 350)
    Clearlevel()
    startLevel()
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.B2, function (sprite, otherSprite) {
    animation.runImageAnimation(
    B2,
    [img`
        . . . . . . . . . . . . . . . . 
...
sprites.onOverlap(SpriteKind.L4Boss, SpriteKind.Projectile, function (sprite, otherSprite) {
    otherSprite.destroy()
    if (L4BossHealth > 1) {
        L4Boss.startEffect(effects.fire, 1000)
        L4BossHealth += -1
        L4BHPHud.say("x" + L4BossHealth)
        music.playTone(147, music.beat(BeatFraction.Sixteenth))
        music.playTone(139, music.beat(BeatFraction.Sixteenth))
        music.playTone(131, music.beat(BeatFraction.Sixteenth))
    } else {
        L4Boss.startEffect(effects.disintegrate)
        for (let value of sprites.allOfKind(SpriteKind.Meteor)) {
            value.destroy()
        }
        ...
        Boss_Trophy = sprites.create(img`
            ................................
            .........55555555555............
            .......554444444444455..........
            ......54444444444444445.........
            .....5444455555555544445........
            ....544455444444444554445.......
            ...54445444444444444454445......
            ..5444544444444444444454445.....
            ..5445444445555555444445445.....
            .544454444544444445444454445....
            .544544445444fff444544445445....
            .544544454444fff444454445445....
            .5445444544444f4444454445445....
            .54454445444fffff44454445445....
            .5445444544fffffff4454445445....
            .544544454fffffffff454445445....
            .544544454fffffffff454445445....
            .5445444544fffffff4454445445....
            .54454444544fffff445f4445445....
            .544454444544444445f4445f445....
            ..5445444445555555f44445445f....
            ..5444544444ffffff44445f445.....
            ...5444544444444444445f445f.....
            ....54445544444444455f445f......
            .....54444555555555ff445f.......
            ......54444ffffffff4445f........
            .......554444444444455f.........
            .........55555555555ff..........
            ...........fffffffff............
            ...
            ................................
            ................................
            `, SpriteKind.bossTrophy)
        Boss_Trophy.setPosition(Daddo.x + 0, Daddo.y + -60)
        Boss_Trophy.setVelocity(0, 20)
        Boss_Trophy.follow(Daddo)
        L4BossHealth = 0
    }
    if (L4BossHealth <= 2) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.B3, function (sprite, otherSprite) {
    animation.runImageAnimation(
    B3,
    [img`
        . . . . . . . . . . . . . . . . 
...
function Level4 () {
    ...
    scene.setBackgroundImage(img`
        ...
        ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        `)
    tiles.setTilemap(tiles.createTilemap(hex``, img`
        .........2...............................2......................................
        .........2...............................2......................................
        .........2...............................2......................................
        .........2...............................2......................................
        ...
        ................................................................................
        `, [myTiles.transparency16,myTiles.tile4,myTiles.tile13,myTiles.tile5,myTiles.tile6,myTiles.tile16,myTiles.tile17,myTiles.tile18,myTiles.tile19,myTiles.tile20,myTiles.tile21,myTiles.tile22,myTiles.tile24,myTiles.tile27,myTiles.tile28,myTiles.tile29,myTiles.tile30,myTiles.tile31,myTiles.tile32,myTiles.tile33,myTiles.tile34,myTiles.tile35,myTiles.tile36,myTiles.tile25,myTiles.tile15], TileScale.Sixteen))
    SpawnMeteor()
}
...
function startLevel () {
    ...
    for (let value of tiles.getTilesByType(myTiles.tile30)) {
        L4Boss = sprites.create(img`
            ...
            `, SpriteKind.L4Boss)
        L4BossHealth = 8
        tiles.placeOnTile(L4Boss, value)
        tiles.setTileAt(value, myTiles.transparency16)
        animation.runImageAnimation(
        L4Boss,
        [img`
    ...
    if (currentLevel == 4 && L4BossHealth != 0) {
        L4BHPHud = sprites.create(img`
            . . 7 7 7 7 . . 
            . . 7 1 1 7 . . 
            . . 7 7 7 7 . . 
            . f f 7 7 f f . 
            ...
            . . . f f . . . 
            `, SpriteKind.HUD)
        L4BHPHud.setFlag(SpriteFlag.Ghost, true)
        L4BHPHud.say(L4BossHealth)
        L4BHPHud.setFlag(SpriteFlag.RelativeToCamera, true)
        L4BHPHud.z = 101
        L4BHPHud.setPosition(5, 17)
        L4BHPHud.say("x" + L4BossHealth)
    }
}
function Rocketfun () {
...
let C3: Sprite = null
let B3: Sprite = null
let Boss_Trophy: Sprite = null
let L4BHPHud: Sprite = null
let L4Boss: Sprite = null
let L4BossHealth = 0
let C4: Sprite = null
let B4: Sprite = null
...
game.onUpdateInterval(1000, function () {
    ...
    if (L4BossHealth != 0) {
        L4BLP = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Indicator)
        L4BLP.setPosition(L4Boss.x + 0, L4Boss.y + 40)
        L4BL = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . 
            . . . . . . . . . . . . 
            . . . . . . . . . . . . 
            . . . . . . . . . . . . 
        ...
        [img`
            ...
            . . 7 7 7 7 7 7 7 7 . . 
            . 7 7 7 a a a a 7 7 7 . 
            7 7 7 a a a a a a 7 7 7 
            7 7 a a a 1 1 a a a 7 7 
            7 7 a a a 1 1 a a a 7 7 
            7 7 a a a 1 1 a a a 7 7 
            7 7 a a a 1 1 a a a 7 7 
            7 7 a a a 1 1 a a a 7 7 
            ...
            7 7 a a a 1 1 a a a 7 7 
            7 7 a a a 1 1 a a a 7 7 
            7 7 7 a a 1 1 a a 7 7 7 
            7 7 7 7 a a a a 7 7 7 7 
            . . . 7 7 7 7 7 7 . . . 
            . . . . . . . . . . . . 
            . . . . . . . . . . . . 
            . . . . . . . . . . . . 
